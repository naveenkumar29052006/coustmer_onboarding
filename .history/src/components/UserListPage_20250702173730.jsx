              ...
              <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-4 py-2 border">Service Details</th>
                  </tr>
                </thead>
                <tbody>
                  {paginatedUsers.map((user, idx) => (
                    <tr key={user._id || idx} className="border-t">
                      ...
                      <td className="px-4 py-2 border">{user.company || user.company_name || '-'}</td>
                      <td className="px-4 py-2 border">{user.phone || '-'}</td>
                      <td className="px-4 py-2 border">{user.created_at ? new Date(user.created_at).toLocaleString() : '-'}</td>
                      <td className="px-4 py-2 border">{formatServiceDetails(user)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
