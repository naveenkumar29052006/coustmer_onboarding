    ...
    return (
        <OnboardingLayout>
            <div className='w-full max-w-6xl mx-auto flex flex-col items-center py-6 bg-transparent p-6 relative min-h-[70vh] font-poppins'>
                <div className="w-full flex flex-col items-center justify-center" style={{ maxWidth: '100vw' }}>
                ...
                {getSubserviceOptions().length > 0 && (
                    <div className="w-full mb-8 flex flex-col items-center justify-center">
                        <h3 className="text-lg font-semibold mb-4 text-gray-800 font-poppins text-center">Additional Services</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl mx-auto">
                            {getSubserviceOptions().map(option => (
                                <div
                                    key={option.id}
                                    onClick={() => handleSubserviceSelection(option.id)}
                                    className={`p-4 border rounded-lg cursor-pointer transition-colors flex items-center font-poppins justify-center ${selectedSubservices.includes(option.id)
