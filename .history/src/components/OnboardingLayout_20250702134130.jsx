...
const getStepSVGs = (stroke = '#333') => [
  ...
  (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13.3333 14V12.6667C13.3333 11.9594 13.0523 11.2811 12.5522 10.781C12.0521 10.281 11.3739 10 10.6666 10H5.33329C4.62605 10 3.94777 10.281 3.44767 10.781C2.94758 11.2811 2.66663 11.9594 2.66663 12.6667V14M10.6666 4.66667C10.6666 6.13943 9.47272 7.33333 7.99996 7.33333C6.5272 7.33333 5.33329 6.13943 5.33329 4.66667C5.33329 3.19391 6.5272 2 7.99996 2C9.47272 2 10.6666 3.19391 10.6666 4.66667Z" stroke={stroke} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.66663 1.33331H3.99996C3.64634 1.33331 3.3072 1.47379 3.05715 1.72384C2.8071 1.97389 2.66663 2.31302 2.66663 2.66665V13.3333C2.66663 13.6869 2.8071 14.0261 3.05715 14.2761C3.3072 14.5262 3.64634 14.6666 3.99996 14.6666H12C12.3536 14.6666 12.6927 14.5262 12.9428 14.2761C13.1928 14.0261 13.3333 13.6869 13.3333 13.3333V5.99998M8.66663 1.33331L13.3333 5.99998M8.66663 1.33331L8.66663 5.99998L13.3333 5.99998" stroke={stroke} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
];
...
const OnboardingLayout = ({ children, stepStatus: propStepStatus }) => {
  ...
  // Replace the stepSVGs array with a call to getStepSVGs
  const stepSVGs = getStepSVGs();
